 ...
 */
PG_GLOBAL_RUNTIME row_security_policy_hook_type row_security_policy_hook_permissive = NULL;
PG_GLOBAL_RUNTIME row_security_policy_hook_type row_security_policy_hook_restrictive = NULL;
